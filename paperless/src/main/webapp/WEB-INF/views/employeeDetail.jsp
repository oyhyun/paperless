				...
				<table class="empInfoTable">
					<tr>
							...
							<td rowspan="8" style="width:400px">
								<img class="emp_img" alt="사원사진" src="/img/${requestScope.empDTO.emp_img}" style="width:250px; height: 300px;">
								<input type="hidden" name="img_old" value="${requestScope.empDTO.emp_img}">
							</c:if>
							
							<c:if test="${requestScope.role == 'USER'}">
							<td rowspan="8" style="width:400px">
								<img class="emp_img" alt="사원사진" src="/img/${requestScope.employeeDTO.emp_img}" style="width:250px; height: 300px;">
								<input type="hidden" name="img_old" value="${requestScope.employeeDTO.emp_img}">
							</c:if>
							<br><br>
							<input type="file" name="img" class="img" style="width:250px;">
							<input type="checkbox" name="isDel" value="yes" style="width:10px;">삭제
						</td>
						<th>이 름</th>
						<td>
							<c:if test="${requestScope.role == 'MANAGER'}">
