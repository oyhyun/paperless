			...
			<form name="reportRegForm" method="post" action="">
				...
				<table>
					...
					<tr>
						...
						<td colspan="3">
							<table>
								...
								<tr>
									<td><input type="text" name="sales_company" class="sales_company" value=""></td>
									<td><input type="text" name="sales_name" class="sales_name" value=""></td>
									<td><input type="text" name="sales_jikup" class="sales_jikup" value=""></td>
									<td><input type="text" name="sales_phone" class="sales_phone" value=""></td>
								</tr>
							</table>
						</td>
					</tr>
					...
					<tr>
						<th>영업 내용</th>
						<td colspan="3">
							<textarea name="sales_content" class="sales_content" rows="15" cols="150" maxlength="500"></textarea>
						</td>
					</tr>
					<tr>
						<th>영업 성과</th>
						<td colspan="3">
							<textarea name="sales_result" class="sales_result" rows="15" cols="150" maxlength="500"></textarea>
						</td>
					</tr>
				</table>
