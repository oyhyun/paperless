      ...
      <div class="container">
         ...
         <div>
            <table>
               <tr>
                  <th>제목</th>
                  <td colspan="5">${requestScope.reportDTO.title}</td>
               </tr>
               ...
               <tr>
                  ...
                  <th>직 급</th>
                  <td>${requestScope.reportDTO.jikup_name}</td>
                  <th>연락처</th>
                  <td>${requestScope.reportDTO.phone_num}</td>
               </tr>
               ...
               <c:if test="${requestScope.reportDTO.report_code == 1}">
                  <tr style="height: 300px;">
                     <th>업무 내용</th>
                     <td colspan="5" >${requestScope.reportDTO.content}</td>
                  </tr>
               </c:if>
                  ...
                  <td colspan="6">
                        <table style="width: 1200px;">
                           <tr>
                              ...
                              <th style="width: 250px;">결재자명</th>
                              <th style="width: 100px;">부서명</th>
                              <th style="width: 100px;">직 책</th>
                              <th style="width: 100px;">결재여부</th>
                              <th style="width: 300px;">결재일</th>
